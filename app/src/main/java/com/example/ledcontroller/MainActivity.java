...
public class MainActivity extends AppCompatActivity  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (! mBtAdapter.isEnabled()) {
            mBluetoothStatus.setText("Bluetooth włączone");
            ...
            public void handleMessage(android.os.Message msg) {
                ...
                if (msg.what == CONNECTING_STATUS) {
                    if (msg.arg1 == 1)
                        ...
                        mBluetoothStatus.setText("Nieudane połączenie");
                }
            }
        };
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
               textView.setText("" + progress + "%");
                if (mConnectedThread != null) {
                    String jasnosnPWM = Integer.toString(progress);
                    mConnectedThread.write("p"+jasnosnPWM);
                }
            }
        ...
        if (mBTAdapter.isEnabled()) {
            AmbilWarnaDialog ambilWarnaDialog = new AmbilWarnaDialog(this, DefaultColor, new AmbilWarnaDialog.OnAmbilWarnaListener() {
                ...
                public void onCancel(AmbilWarnaDialog dialog) {
                    Toast.makeText(MainActivity.this, "Paleta kolorów zakmnięta", Toast.LENGTH_SHORT).show();
                }
                ...
                public void onOk(AmbilWarnaDialog dialog, int color) {
                    if (mConnectedThread != null) { //First check to make sure thread created
                        ...
                        Toast.makeText(MainActivity.this, "Nie sparowano z urządzeniem, paleta kolorów zakmnięta", Toast.LENGTH_SHORT).show();
                    }
            ...
            Toast.makeText(getApplicationContext(), "Bluetooth nie jest właczone", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent Data) {
        ...
        if (requestCode == REQUEST_ENABLE_BT) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mBluetoothStatus.setText("Bluetooth wyłączone");
        }
    }
    ...
    private void discover(View view) {
        ...
        if (mBTAdapter.isDiscovering()) {
            ...
            Toast.makeText(getApplicationContext(), "Zatrzymano wyszukiwanie", Toast.LENGTH_SHORT).show();
        } else {
            if (mBTAdapter.isEnabled()) {
                mBTArrayAdapter.clear(); // clear items
                mBTAdapter.startDiscovery();
                Toast.makeText(getApplicationContext(), "Rozpoczęto wyszukiwanie", Toast.LENGTH_SHORT).show();
    ...
    private void listPairedDevices(View view) {
        ...
        if (mBTAdapter.isEnabled()) {
            ...
            Toast.makeText(getApplicationContext(), "Bluetooth jest wyłączone", Toast.LENGTH_SHORT).show();
    }
